...
export function listZalouserAccountIds(cfg: MaistroConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: MaistroConfig): string {
...
function mergeZalouserAccountConfig(cfg: MaistroConfig, accountId: string): ZalouserAccountConfig {
