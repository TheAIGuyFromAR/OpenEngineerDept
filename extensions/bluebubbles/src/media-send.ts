...
import { resolveChannelMediaMaxBytes, type MaistroConfig } from "maistro/plugin-sdk";
...
function resolveMediaLocalRoots(params: { cfg: MaistroConfig; accountId?: string }): string[] {
