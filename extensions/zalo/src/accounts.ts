...
export function resolveDefaultZaloAccountId(cfg: MaistroConfig): string {
...
function mergeZaloAccountConfig(cfg: MaistroConfig, accountId: string): ZaloAccountConfig {
...
export function listEnabledZaloAccounts(cfg: MaistroConfig): ResolvedZaloAccount[] {
