import type { ChannelOnboardingAdapter, MaistroConfig, WizardPrompter } from "maistro/plugin-sdk";
...
async function noteMattermostSetup(prompter: WizardPrompter): Promise<void> {
  await prompter.note(
    [
      ...
      "Docs: https://docs.maistro.ai/channels/mattermost",
    ].join("\n"),
