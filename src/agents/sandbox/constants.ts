...
export const DEFAULT_SANDBOX_IMAGE = "maistro-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "maistro-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "maistro-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "maistro-sandbox-common:bookworm-slim";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "maistro-sbx-browser-";
