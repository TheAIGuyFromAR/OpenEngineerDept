...
describe("createMaistroCodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    ...
    const openAiTools = createMaistroCodingTools({
      config,
    ...
    const anthropicTools = createMaistroCodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createMaistroCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createMaistroCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
