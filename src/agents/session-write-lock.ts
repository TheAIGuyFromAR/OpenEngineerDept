...
const CLEANUP_STATE_KEY = Symbol.for("maistro.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("maistro.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("maistro.sessionWriteLockWatchdogState");
