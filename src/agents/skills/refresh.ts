...
function resolveWatchPaths(workspaceDir: string, config?: MaistroConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: MaistroConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: MaistroConfig }) {
