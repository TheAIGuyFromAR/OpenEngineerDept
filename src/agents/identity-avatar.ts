...
function resolveAvatarSource(cfg: MaistroConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: MaistroConfig, agentId: string): AgentAvatarResolution {
