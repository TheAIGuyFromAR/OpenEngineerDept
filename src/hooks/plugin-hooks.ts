...
import type { MaistroPluginApi } from "../plugins/types.js";
...
function resolveHookDir(api: MaistroPluginApi, dir: string): string {
...
function normalizePluginHookEntry(api: MaistroPluginApi, entry: HookEntry): HookEntry {
  return {
    ...entry,
    hook: {
      ...entry.hook,
