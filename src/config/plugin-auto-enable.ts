...
function isTelegramConfigured(cfg: MaistroConfig, env: NodeJS.ProcessEnv): boolean {
...
function isDiscordConfigured(cfg: MaistroConfig, env: NodeJS.ProcessEnv): boolean {
...
function isIrcConfigured(cfg: MaistroConfig, env: NodeJS.ProcessEnv): boolean {
...
function isSlackConfigured(cfg: MaistroConfig, env: NodeJS.ProcessEnv): boolean {
  if (
...
function isSignalConfigured(cfg: MaistroConfig): boolean {
...
function isIMessageConfigured(cfg: MaistroConfig): boolean {
...
function isWhatsAppConfigured(cfg: MaistroConfig): boolean {
...
function isGenericChannelConfigured(cfg: MaistroConfig, channelId: string): boolean {
...
function collectModelRefs(cfg: MaistroConfig): string[] {
  const refs: string[] = [];
...
function isProviderConfigured(cfg: MaistroConfig, providerId: string): boolean {
...
function isPluginExplicitlyDisabled(cfg: MaistroConfig, pluginId: string): boolean {
  const entry = cfg.plugins?.entries?.[pluginId];
  return entry?.enabled === false;
}

function isPluginDenied(cfg: MaistroConfig, pluginId: string): boolean {
...
function registerPluginEntry(cfg: MaistroConfig, pluginId: string): MaistroConfig {
  const entries = {
    ...cfg.plugins?.entries,
    [pluginId]: {
