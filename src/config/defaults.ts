...
function resolveAnthropicDefaultAuthMode(cfg: MaistroConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: MaistroConfig): MaistroConfig {
...
export function applyTalkApiKey(config: MaistroConfig): MaistroConfig {
...
export function applyModelDefaults(cfg: MaistroConfig): MaistroConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: MaistroConfig): MaistroConfig {
...
export function applyLoggingDefaults(cfg: MaistroConfig): MaistroConfig {
...
export function applyContextPruningDefaults(cfg: MaistroConfig): MaistroConfig {
...
export function applyCompactionDefaults(cfg: MaistroConfig): MaistroConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
