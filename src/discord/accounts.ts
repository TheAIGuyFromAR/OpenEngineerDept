...
function mergeDiscordAccountConfig(cfg: MaistroConfig, accountId: string): DiscordAccountConfig {
...
export function listEnabledDiscordAccounts(cfg: MaistroConfig): ResolvedDiscordAccount[] {
