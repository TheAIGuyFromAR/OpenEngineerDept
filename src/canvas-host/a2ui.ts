...
export const A2UI_PATH = "/__maistro__/a2ui";

export const CANVAS_HOST_PATH = "/__maistro__/canvas";

export const CANVAS_WS_PATH = "/__maistro__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.maistroCanvasA2UIAction.postMessage(...)
  // - Android: window.maistroCanvasA2UIAction.postMessage(...)
  const handlerNames = ["maistroCanvasA2UIAction"];
  ...
  globalThis.Maistro = globalThis.Maistro ?? {};
  globalThis.Maistro.postMessage = postToNode;
  globalThis.Maistro.sendUserAction = sendUserAction;
  globalThis.maistroPostMessage = postToNode;
  globalThis.maistroSendUserAction = sendUserAction;
