...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof MaistroConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: MaistroConfig; env: NodeJS.ProcessEnv }): {
  cfg: MaistroConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
