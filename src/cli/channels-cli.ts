    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["maistro channels list", "List configured channels and auth profiles."],
          ["maistro channels status --probe", "Run channel status checks and probes."],
          [
            "maistro channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["maistro channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.maistro.ai/cli/channels",
        )}\n`,
    );
