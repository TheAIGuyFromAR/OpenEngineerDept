      ...
      .addHelpText(
        ...
        () =>
          `\n${theme.heading("Examples:")}\n${formatHelpExamples([
            ["maistro gateway run", "Run the gateway in the foreground."],
            ["maistro gateway status", "Show service status and probe reachability."],
            ["maistro gateway discover", "Find local and wide-area gateway beacons."],
            ["maistro gateway call health", "Call a gateway RPC method directly."],
          ])}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/gateway", "docs.maistro.ai/cli/gateway")}\n`,
      ),
  );
