    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["maistro directory self --channel slack", "Show the connected account identity."],
          [
            'maistro directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["maistro directory groups list --channel discord", "List available groups/channels."],
          [
            "maistro directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.maistro.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
