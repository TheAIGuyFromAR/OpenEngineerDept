...
describe("tts", () => {
  ...
  describe("maybeApplyTtsToPayload", () => {
    ...
    const withMockedAutoTtsFetch = async (
      ...
      const prevPrefs = process.env.MAISTRO_TTS_PREFS;
      process.env.MAISTRO_TTS_PREFS = `/tmp/tts-test-${Date.now()}.json`;
      ...
      try {
        ...
        process.env.MAISTRO_TTS_PREFS = prevPrefs;
      }
    };

    const taggedCfg: MaistroConfig = {
      ...baseCfg,
      messages: {
        ...baseCfg.messages!,
