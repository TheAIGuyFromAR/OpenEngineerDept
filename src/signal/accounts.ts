...
function mergeSignalAccountConfig(cfg: MaistroConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: MaistroConfig): ResolvedSignalAccount[] {
