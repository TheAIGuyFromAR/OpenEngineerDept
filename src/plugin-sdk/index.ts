...
export type { MaistroConfig } from "../config/config.js";
/** @deprecated Use MaistroConfig instead */
export type { MaistroConfig as MaistroConfig } from "../config/config.js";
