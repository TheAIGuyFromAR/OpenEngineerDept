...
import { type MaistroConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: MaistroConfig): string[] {
...
export function listAgentsForGateway(cfg: MaistroConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: MaistroConfig): string {
...
function resolveSessionStoreAgentId(cfg: MaistroConfig, canonicalKey: string): string {
...
export function loadCombinedSessionStoreForGateway(cfg: MaistroConfig): {
  storePath: string;
  store: Record<string, SessionEntry>;
} {
...
export function getSessionDefaults(cfg: MaistroConfig): GatewaySessionsDefaults {
