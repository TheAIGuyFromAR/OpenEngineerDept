...
export function listWhatsAppAuthDirs(cfg: MaistroConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: MaistroConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: MaistroConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: MaistroConfig): ResolvedWhatsAppAccount[] {
