...
function resolveMentionPatterns(cfg: MaistroConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: MaistroConfig | undefined, agentId?: string): RegExp[] {
