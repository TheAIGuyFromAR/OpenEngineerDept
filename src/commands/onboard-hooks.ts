...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.maistro.ai/automation/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("maistro hooks list")}`,
      `  ${formatCliCommand("maistro hooks enable <name>")}`,
      `  ${formatCliCommand("maistro hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
