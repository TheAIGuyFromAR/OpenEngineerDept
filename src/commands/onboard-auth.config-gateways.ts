...
export function applyVercelAiGatewayProviderConfig(cfg: MaistroConfig): MaistroConfig {
...
export function applyVercelAiGatewayConfig(cfg: MaistroConfig): MaistroConfig {
