...
async function withTempHome<T>(fn: (home: string) => Promise<T>): Promise<T> {
  return withTempHomeBase(fn, { prefix: "maistro-agent-" });
}

function mockConfig(
  home: string,
  storePath: string,
  agentOverrides?: Partial<NonNullable<NonNullable<MaistroConfig["agents"]>["defaults"]>>,
  telegramOverrides?: Partial<NonNullable<MaistroConfig["telegram"]>>,
