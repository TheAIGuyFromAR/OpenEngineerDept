...
function resolveDefaultAccountId(cfg: MaistroConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: MaistroConfig): boolean {
...
export function summarizeBindings(cfg: MaistroConfig, bindings: AgentBinding[]): string[] {
