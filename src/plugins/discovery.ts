...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @maistro/voice-call -> voice-call).
...
export function discoverMaistroPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ...
  if (workspaceDir) {
    ...
    const workspaceExtDirs = [path.join(workspaceRoot, ".maistro", "extensions")];
