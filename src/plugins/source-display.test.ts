...
describe("formatPluginSourceForTable", () => {
  it("shortens bundled plugin sources under the stock root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "bundled",
        source: "/opt/homebrew/lib/node_modules/maistro/extensions/bluebubbles/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/maistro/extensions",
        global: "/Users/x/.maistro/extensions",
        workspace: "/Users/x/ws/.maistro/extensions",
      },
    );
  ...
  it("shortens workspace plugin sources under the workspace root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "workspace",
        source: "/Users/x/ws/.maistro/extensions/matrix/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/maistro/extensions",
        global: "/Users/x/.maistro/extensions",
  ...
  it("shortens global plugin sources under the global root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "global",
        source: "/Users/x/.maistro/extensions/zalo/index.js",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/maistro/extensions",
        global: "/Users/x/.maistro/extensions",
