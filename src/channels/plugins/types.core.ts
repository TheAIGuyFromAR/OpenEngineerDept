...
export type ChannelAgentToolFactory = (params: { cfg?: MaistroConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: MaistroConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: MaistroConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: MaistroConfig }) => boolean;
  supportsCards?: (params: { cfg: MaistroConfig }) => boolean;
