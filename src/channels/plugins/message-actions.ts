...
export function listChannelMessageActions(cfg: MaistroConfig): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: MaistroConfig): boolean {
  for (const plugin of listChannelPlugins()) {
...
export function supportsChannelMessageCards(cfg: MaistroConfig): boolean {
  for (const plugin of listChannelPlugins()) {
