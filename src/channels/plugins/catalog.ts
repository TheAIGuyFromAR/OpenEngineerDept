...
import { discoverMaistroPlugins } from "../../plugins/discovery.js";
import type { MaistroPackageManifest } from "../../plugins/manifest.js";
...
const ENV_CATALOG_PATHS = ["MAISTRO_PLUGIN_CATALOG_PATHS", "MAISTRO_MPM_CATALOG_PATHS"];
...
function toChannelMeta(params: {
  channel: NonNullable<MaistroPackageManifest["channel"]>;
  id: string;
}): ChannelMeta | null {
...
function resolveInstallInfo(params: {
  manifest: MaistroPackageManifest;
  packageName?: string;
  packageDir?: string;
  workspaceDir?: string;
...
function buildCatalogEntry(candidate: {
  ...
  packageDir?: string;
  workspaceDir?: string;
  packageManifest?: MaistroPackageManifest;
...
export function listChannelPluginCatalogEntries(
  ...
  const discovery = discoverMaistroPlugins({ workspaceDir: options.workspaceDir });
