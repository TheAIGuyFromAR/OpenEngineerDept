...
export type RunCronAgentTurnResult = {
   ...
   * messages.  See: https://github.com/maistro/maistro/issues/15692
   */
  delivered?: boolean;
} & CronRunOutcome &
  CronRunTelemetry;
...
export async function runCronIsolatedAgentTurn(params: {
  ...
  const isFastTestEnv = process.env.MAISTRO_TEST_FAST === "1";
  ...
  // correct per-agent paths (e.g. ~/.maistro/agents/<agentId>/agent/).
  ...
  const cfgWithAgentDefaults: MaistroConfig = {
    ...params.cfg,
