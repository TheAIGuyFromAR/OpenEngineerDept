...
// Prefix for Maistro-generated action IDs to scope our handler
const MAISTRO_ACTION_PREFIX = "maistro:";
...
export function registerSlackInteractionEvents(params: { ctx: SlackMonitorContext }) {
  ...
  // Handle Maistro modal submissions with callback_ids scoped by our prefix.
  ctx.app.view(
    new RegExp(`^${MAISTRO_ACTION_PREFIX}`),
