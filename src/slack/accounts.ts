...
function mergeSlackAccountConfig(cfg: MaistroConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: MaistroConfig): ResolvedSlackAccount[] {
