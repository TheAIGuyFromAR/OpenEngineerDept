...
describe("setupOnboardingShellCompletion", () => {
  it("QuickStart: installs without prompting", async () => {
    ...
    expect(deps.ensureCompletionCacheExists).toHaveBeenCalledWith("maistro");
    expect(deps.installCompletion).toHaveBeenCalledWith("zsh", true, "maistro");
