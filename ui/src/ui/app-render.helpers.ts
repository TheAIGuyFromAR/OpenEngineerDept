...
function resetChatStateForSessionSwitch(state: AppViewState, sessionKey: string) {
  ...
  (state as unknown as MaistroApp).chatStreamStartedAt = null;
  state.chatRunId = null;
  (state as unknown as MaistroApp).resetToolStream();
  (state as unknown as MaistroApp).resetChatScroll();
  state.applySettings({
    ...state.settings,
    sessionKey,
  ...
  return html`
    <div class="chat-controls">
      ...
      <button
        ...
        @click=${async () => {
          const app = state as unknown as MaistroApp;
