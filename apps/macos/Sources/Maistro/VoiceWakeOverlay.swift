...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.maistro", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other Maistro windows, but below the system’s pop-up menus.
