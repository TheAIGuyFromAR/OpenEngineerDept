...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.maistro", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.maistro", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [MaistroChatMessage] = messages.compactMap { item in
