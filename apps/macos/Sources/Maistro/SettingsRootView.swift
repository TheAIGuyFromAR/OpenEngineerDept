...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .maistroSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? MaistroPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? MaistroPaths.stateDirURL.path
...
extension Notification.Name {
    static let maistroSelectSettingsTab = Notification.Name("maistroSelectSettingsTab")
}
