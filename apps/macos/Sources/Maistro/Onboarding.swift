...
enum UIStrings {
    static let welcomeTitle = "Welcome to Maistro"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "maistro.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: MaistroOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: MaistroChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g maistro@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: MaistroChatViewModel(
