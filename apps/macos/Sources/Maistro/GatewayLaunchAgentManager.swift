...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.maistro", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".maistro/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.maistroCommand(
            subcommand: "gateway",
