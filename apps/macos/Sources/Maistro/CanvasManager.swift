...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.maistro", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("Maistro/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__maistro__/a2ui/").absoluteString + "?platform=macos"
    }
