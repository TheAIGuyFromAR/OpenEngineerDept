...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/maistro/maistro") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/maistro/maistro")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://maistro.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "MaistroBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "MaistroBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "MaistroGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "MaistroGitCommit") as? String) ??
            "unknown"
    }
