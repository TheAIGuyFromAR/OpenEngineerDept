...
private let onboardingWizardLogger = Logger(subsystem: "ai.maistro", category: "onboarding.wizard")

// MARK: - Swift 6 AnyCodable Bridging Helpers

// Bridge between MaistroProtocol.AnyCodable and the local module to avoid
// Swift 6 strict concurrency type conflicts.

private typealias ProtocolAnyCodable = MaistroProtocol.AnyCodable
