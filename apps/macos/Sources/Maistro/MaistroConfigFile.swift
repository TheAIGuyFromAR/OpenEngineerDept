...
enum MaistroConfigFile {
    private static let logger = Logger(subsystem: "ai.maistro", category: "config")
    ...
    static func stateDirURL() -> URL {
        MaistroPaths.stateDirURL
    }

    static func defaultWorkspaceURL() -> URL {
        MaistroPaths.workspaceURL
    }
    ...
    private static func appendConfigWriteAudit(_ fields: [String: Any]) {
        var record: [String: Any] = [
            ...
            "source": "macos-maistro-config-file",
            "event": "config.write",
