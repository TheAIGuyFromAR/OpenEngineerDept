...
final class ScreenController {
    ...
    /// Callback invoked when an maistro:// deep link is tapped in the canvas
    ...
    private static func bundledResourceURL(
        ...
        -> URL?
    {
        let bundle = MaistroKitResources.bundle
...
/// Handles navigation policy to intercept maistro:// deep links from canvas
@MainActor
private final class ScreenNavigationDelegate: NSObject, WKNavigationDelegate {
        ...
        decisionHandler: @escaping @MainActor @Sendable (WKNavigationActionPolicy) -> Void)
    {
        ...
        // Intercept maistro:// deep links.
        if url.scheme?.lowercased() == "maistro" {
