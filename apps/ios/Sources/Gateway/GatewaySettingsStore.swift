...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.maistro.gateway"
    private static let nodeService = "ai.maistro.node"
    private static let talkService = "ai.maistro.talk"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.maistro.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.maistro.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .documentDirectory, in: .userDomainMask).first?
            .appendingPathComponent("maistro-gateway.log")
    }
