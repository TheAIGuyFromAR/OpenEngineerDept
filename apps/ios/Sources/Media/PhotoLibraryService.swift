...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: MaistroPhotosLatestParams) async throws -> MaistroPhotosLatestPayload {
        ...
        var results: [MaistroPhotoPayload] = []
        ...
        return MaistroPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> MaistroPhotoPayload
    {
