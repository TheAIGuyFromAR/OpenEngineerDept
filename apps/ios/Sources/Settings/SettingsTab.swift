...
struct SettingsTab: View {
    ...
    @AppStorage("location.enabledMode") private var locationEnabledModeRaw: String = MaistroLocationMode.off.rawValue
    ...
    @State private var lastLocationModeRaw: String = MaistroLocationMode.off.rawValue
    ...
    private let gatewayLogger = Logger(subsystem: "ai.maistro.ios", category: "GatewaySettings")
    ...
    var body: some View {
        NavigationStack {
                ...
                Section("Device") {
                    DisclosureGroup("Features") {
                        ...
                        Picker("Location Access", selection: self.$locationEnabledModeRaw) {
                            Text("Off").tag(MaistroLocationMode.off.rawValue)
                            Text("While Using").tag(MaistroLocationMode.whileUsing.rawValue)
                            Text("Always").tag(MaistroLocationMode.always.rawValue)
                        }
                        ...
                        Text("Keeps the screen awake while Maistro is open.")
                            .font(.footnote)
                            .foregroundStyle(.secondary)
                    }
            ...
            .onChange(of: self.locationEnabledModeRaw) { _, newValue in
                ...
                guard let mode = MaistroLocationMode(rawValue: newValue) else { return }
                Task {
    ...
    private var locationMode: MaistroLocationMode {
        MaistroLocationMode(rawValue: self.locationEnabledModeRaw) ?? .off
    }
