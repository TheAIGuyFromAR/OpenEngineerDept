...
public typealias MaistroPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias MaistroPlatformImage = UIImage
#endif

public struct MaistroChatUsageCost: Codable, Hashable, Sendable {
...
public struct MaistroChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: MaistroChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(MaistroChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct MaistroChatMessageContent: Codable, Hashable, Sendable {
...
public struct MaistroChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [MaistroChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: MaistroChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [MaistroChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: MaistroChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(MaistroChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([MaistroChatMessageContent].self, forKey: .content) {
...
public struct MaistroChatHistoryPayload: Codable, Sendable {
...
public struct MaistroSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct MaistroSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [MaistroSessionPreviewItem]
}

public struct MaistroSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [MaistroSessionPreviewEntry]

    public init(ts: Int, previews: [MaistroSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct MaistroChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct MaistroChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct MaistroAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct MaistroChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct MaistroGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct MaistroPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: MaistroPlatformImage?
...
public struct MaistroChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
