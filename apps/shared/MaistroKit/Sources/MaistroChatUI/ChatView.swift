...
@MainActor
public struct MaistroChatView: View {
    public enum Style {
        case standard
        case onboarding
    }

    @State private var viewModel: MaistroChatViewModel
    ...
    public init(
        viewModel: MaistroChatViewModel,
    ...
    private var visibleMessages: [MaistroChatMessage] {
        let base: [MaistroChatMessage]
    ...
    private func mergeToolResults(in messages: [MaistroChatMessage]) -> [MaistroChatMessage] {
    ...
    private func isToolResultMessage(_ message: MaistroChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: MaistroChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: MaistroChatMessage) -> String {
