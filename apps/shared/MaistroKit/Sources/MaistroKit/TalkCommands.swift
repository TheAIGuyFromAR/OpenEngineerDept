...
public enum MaistroTalkCommand: String, Codable, Sendable {
...
public struct MaistroTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct MaistroTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
