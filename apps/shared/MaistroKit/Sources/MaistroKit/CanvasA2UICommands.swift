...
public enum MaistroCanvasA2UICommand: String, Codable, Sendable {
...
public struct MaistroCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct MaistroCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
