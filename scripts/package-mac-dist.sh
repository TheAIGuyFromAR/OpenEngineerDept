...
# Output:
# - dist/Maistro.app
# - dist/Maistro-<version>.zip
# - dist/Maistro-<version>.dmg
...
ZIP="$ROOT_DIR/dist/Maistro-$VERSION.zip"
DMG="$ROOT_DIR/dist/Maistro-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/Maistro-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/Maistro-$VERSION.dSYM.zip"
