...
const STATE_FILE_PATH = join(CONFIG_BASE_DIR, "maistro", STATE_FILE_NAME);
      ...
      input: [
        {
          role: "system",
          content:
            "You classify GitHub issues and pull requests for Maistro. Respond with JSON only, no extra text.",
        },
        {
          role: "user",
          content: [
...
async function main() {
  ...
  logHeader("Maistro Issue Label Audit");
