...
- Keep product names in English: Maistro, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the Maistro Gateway, use “Gateway 网关”.
