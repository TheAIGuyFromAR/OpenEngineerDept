...
show_usage() {
    cat << EOF
clawlog - Maistro Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View Maistro logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    Maistro logs flow through the macOS unified log (subsystem: ai.maistro).
