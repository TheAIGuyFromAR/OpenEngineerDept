...
docker run --rm -t \
  ...
  -e MAISTRO_LIVE_GATEWAY_MODELS="${MAISTRO_LIVE_GATEWAY_MODELS:-${MAISTRO_LIVE_GATEWAY_MODELS:-all}}" \
  -e MAISTRO_LIVE_GATEWAY_PROVIDERS="${MAISTRO_LIVE_GATEWAY_PROVIDERS:-${MAISTRO_LIVE_GATEWAY_PROVIDERS:-}}" \
  -e MAISTRO_LIVE_GATEWAY_MODEL_TIMEOUT_MS="${MAISTRO_LIVE_GATEWAY_MODEL_TIMEOUT_MS:-${MAISTRO_LIVE_GATEWAY_MODEL_TIMEOUT_MS:-}}" \
